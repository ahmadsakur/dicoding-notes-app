  ...
  return (
    <div className="p-4 max-w-xs text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
      ...
      <div className="flex item-center gap-x-2">
        <div class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-gray-900 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300">
          {archived ? (
            <>
              <Notes />
              <div>Restore</div>
